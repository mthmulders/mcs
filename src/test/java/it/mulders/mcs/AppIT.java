...
class AppIT implements WithAssertions {
  ...
  void should_set_proxy_system_properties_when_env_variables_are_present() throws Exception {
    List<String> values =
        withEnvironmentVariable("HTTP_PROXY", "http://http.proxy.example.com:8080")
    ...
    assertThat(values)
        .isEqualTo(asList("http.proxy.example.com", "8080", "https.proxy.example.com", "8484"));
  }
}
