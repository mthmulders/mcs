...
class SearchResponseBodyHandlerTest implements WithAssertions {
  /**
   * This is the response we get when the user uses the "wildcard" search - not looking for an exact
   * coordinate, but looking for something like "plexus-utils".
   */
  @Test
  ...
  /**
   * This is the response we get when the user searches for a coordinate including a version - e.g.
  ...
  /**
   * This is the response we get when the user searches for a coordinate without a version - e.g.
   * "org.codehaus.plexus:plexus-utils".
   */
  @Test
