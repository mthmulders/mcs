...
class NoOutputPrinterTest implements WithAssertions {
    ...
    void should_fail_with_non_empty_result() {
        assertThatThrownBy(() -> printer.print(null, responseWithResult(1), new PrintStream(outputStream), null))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> printer.print(null, responseWithResult(2), new PrintStream(outputStream), null))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void should_print_message_with_empty_result() {
        printer.print(null, responseWithResult(0), new PrintStream(outputStream), null);
